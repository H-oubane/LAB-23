...
Java_com_example_monjnidemo_MainActivity_salutDeJNI(
    ...
    return env->NewStringUTF("Bonjour  du  C++ via JNI !");
}
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_monjnidemo_MainActivity_inverserChaine(
        JNIEnv* env,
        jobject /* this */,
        jstring javaString) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_monjnidemo_MainActivity_sommeTableau(
        JNIEnv* env,
        jobject /* this */,
        jintArray array) {
